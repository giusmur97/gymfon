...
export class GoogleCalendarService {
  ...
  async createEvent(calendarId: string, eventData: CalendarEvent): Promise<string> {
    try {
  ...
  async updateEvent(calendarId: string, eventId: string, eventData: CalendarEvent): Promise<void> {
    try {
  ...
  async getEvents(calendarId: string, timeMin: Date, timeMax: Date): Promise<any[]> {
    try {
  ...
  // Check for conflicts
  async checkConflicts(calendarId: string, startTime: Date, endTime: Date, excludeEventId?: string): Promise<boolean> {
    try {
  ...
  async syncTrainingSession(session: any, calendarId: string): Promise<string | null> {
    try {
...
${session.meetingLink ? `- Meeting Link: ${session.meetingLink}` : ''}
  ...
  async removeTrainingSession(calendarId: string, eventId: string): Promise<void> {
    try {
...
export async function getGoogleCalendarService(userId: string): Promise<GoogleCalendarService | null> {
  try {
...
export async function syncAllTrainerSessions(trainerId: string): Promise<void> {
  try {
